...
namespace ProbeNpp {
    ...
    internal class Res {
        ...
        /// <summary>
        ///   Looks up a localized string similar to after asc before button by comment col create desc display endgroup form group index many nopick on one order prompt relationship row snapshot table to unique updates zoom.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to after all and asc before break button by comment case col colff cols continue default desc each else extern extract for format from group header if of or order outfile permanent prompt return row rows select static switch where while widthof.
        /// </summary>
