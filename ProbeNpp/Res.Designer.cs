...
namespace ProbeNpp {
    ...
    internal class Res {
        ...
        /// <summary>
        ///   Looks up a localized string similar to after asc before button by comment col create desc display endgroup form group index many modal nopick on one order prompt relationship row snapshot table to unique updates zoom.
        /// </summary>
